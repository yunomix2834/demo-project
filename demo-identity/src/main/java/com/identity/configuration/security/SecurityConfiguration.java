...
import static com.identity.constant.config.SecurityConfigConstant.ACCEPT_HEADER;
import static com.identity.constant.config.SecurityConfigConstant.AUTHORIZATION_HEADER;
import static com.identity.constant.config.SecurityConfigConstant.CONTENT_TYPE_HEADER;
import static com.identity.constant.config.SecurityConfigConstant.DELETE_METHOD;
import static com.identity.constant.config.SecurityConfigConstant.FRONTEND_ENDPOINT;
import static com.identity.constant.config.SecurityConfigConstant.GET_METHOD;
import static com.identity.constant.config.SecurityConfigConstant.OPTIONS_METHOD;
import static com.identity.constant.config.SecurityConfigConstant.PATCH_METHOD;
import static com.identity.constant.config.SecurityConfigConstant.POST_METHOD;
import static com.identity.constant.config.SecurityConfigConstant.PUBLIC_ENDPOINTS;
import static com.identity.constant.config.SecurityConfigConstant.PUT_METHOD;
import static com.identity.constant.config.SecurityConfigConstant.URL_PATTERN_ALL;
